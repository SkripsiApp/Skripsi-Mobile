                  ...
                  children: [
                    ...
                    _buildInputField(
                      ...
                      validator: (value) => value == null || value.isEmpty
                          ? 'Wajib diisi'
                          : (value.length != 5 ? 'Kode pos tidak valid' : null),
                    ),
                    const SizedBox(height: 24),
                    _buildInputField(
                      'Nomor Telepon',
                      ...
                      validator: (value) => value == null || value.isEmpty
                          ? 'Wajib diisi'
                          : (value.length < 10 ? 'Nomor tidak valid' : null),
                    ),
      ...
      child: Obx(() {
        return SizedBox(
          ...
          child: ElevatedButton(
            onPressed: _addressControllers.isLoading.value
                ? null
                : () {
                    if (_formKey.currentState?.validate() ?? false) {
                      ...
                      _addressControllers.addAddress(address);
                    }
                  },
            ...
            child: _addressControllers.isLoading.value
                ? const SizedBox(
                    width: 24,
                    height: 24,
